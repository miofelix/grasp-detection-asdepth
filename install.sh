...
echo "Orbbec DaBai 依赖: 查看 requirements-orbbec.txt 和 README 的 PyOrbbecSDK v1 构建步骤"
echo "RealSense D435 依赖: python3 -m pip install -r requirements-realsense.txt"
